...
{
	public static ArrayList<Vector6> JacobianBody(ArrayList<se3algebra> Blist, Vector thetaList)
	{
	...
	public static ArrayList<Vector6> JacobianSpace(ArrayList<se3algebra> Slist, Vector thetaList)
	{
		if (thetaList.getCols() != 1)
		{
			throw new IllegalArgumentException("thetalist should be vector");
